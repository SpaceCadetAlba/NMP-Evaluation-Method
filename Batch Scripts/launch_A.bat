@ECHO OFF
:: This batch is for RT Test Protocol endpoint A
...
START "" "C:\Users\AudioLab\Desktop\PatrickCairns_DecayEnvStudy_Distributable\Batch Scripts\jacktrip_endpointA.bat" /k
TIMEOUT 60
...
::JACKTRIP - TALKBACK
START "" "C:\Users\AudioLab\Desktop\PatrickCairns_DecayEnvStudy_Distributable\Batch Scripts\jacktrip_TBA.bat" /k